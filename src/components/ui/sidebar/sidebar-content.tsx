  ...
  ({ isCollapsed, content, onClose }, ref) => {
    return (
      <div
        ...
        className="bg-sidebar shadow-ring fixed top-0 -left-full z-50 hidden h-full w-60 flex-col gap-2 p-2 shadow-sm transition-all duration-100 data-[collapsed=true]:left-14 lg:flex"
      >
